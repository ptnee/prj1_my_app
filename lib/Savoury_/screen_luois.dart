...
import 'package:my_app/Savoury_/screen_cttag.dart';
import 'package:my_app/firebase/test_data.dart';

import '../screen_/screen_3_3.dart';
class Screen_luois extends StatelessWidget {
  ...
  var datas = Data_Savoury().tagData;
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: Data,//Data_Savoury().read_drink(),
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Text(
                              ...
                              data[index].Names.substring(0,40),
